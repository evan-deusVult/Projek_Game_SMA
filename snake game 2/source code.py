...
class MAIN:
    ...
    def draw_score(self):
        ...
        bg_rect = pygame.Rect(apple_rect.left, apple_rect.top, score_rect.width+apple_rect.width+6, apple_rect.height)
...
icon_surf = pygame.image.load('graphic/head_up.png')
